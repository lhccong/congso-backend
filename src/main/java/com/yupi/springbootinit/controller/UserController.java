...
public class UserController {
    ...
    public BaseResponse<LoginUserVO> userMpLogin(@RequestBody UserMpLoginRequest userMpLoginRequest, HttpServletRequest request) {
        ...
        LoginUserVO loginUserVO = userService.userMpLogin(mpCode, request);
        return ResultUtils.success(loginUserVO);
    }
